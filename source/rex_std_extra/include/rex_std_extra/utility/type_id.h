  ...
  inline namespace v1
  {
    namespace internal
    {
      ...
      constexpr rsl::string_view msvc_class_type_name()
      {
        ...
        // fails to find substring and returns nullptr somewhere.
      ...
      constexpr rsl::string_view msvc_struct_type_name()
      {
        rsl::string_view name = __FUNCSIG__;
        constexpr rsl::string_view func_name = __FUNCSIG__;
        constexpr rsl::string_view prefix = "class rsl::v1::basic_string_view<char,class rsl::v1::char_traits<char> > __cdecl rsl::v1::internal::msvc_class_type_name<struct ";
        constexpr rsl::string_view suffix = ",true>(void)";
      ...
      constexpr rsl::string_view type_name()
      {
        ...
        constexpr rsl::string_view func_name = __FUNCSIG__;
        constexpr rsl::string_view prefix = "rsl::string_view type_name() [T = ";
        ...
        rsl::string_view name = __PRETTY_FUNCTION__;
        constexpr rsl::string_view func_name = __FUNCSIG__;
        constexpr rsl::string_view prefix = "constexpr rsl::string_view type_name() [with T = ";
        constexpr rsl::string_view suffix = "]";
        ...
        constexpr rsl::string_view func_name = __FUNCSIG__;
        if constexpr (func_name.contains("class"))
        {
...
#ifdef REX_COMPILER_CLANG
        rsl::string_view name = __PRETTY_FUNCTION__;
        rsl::string_view prefix = "rsl::string_view type_name() [T = ";
        rsl::string_view suffix = "]";
#elif defined(REX_COMPILER_GCC)
        rsl::string_view name = __PRETTY_FUNCTION__;
        rsl::string_view prefix = "constexpr rsl::string_view type_name() [with T = ";
        rsl::string_view suffix = "]";
#elif defined(REX_COMPILER_MSVC)
        rsl::string_view name = __FUNCSIG__;
        constexpr rsl::string_view func_name = __FUNCSIG__;
