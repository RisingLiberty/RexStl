...
//    template <typename T>
//    atomic_t<T> atomic_fetch_add_msvc(T* obj, T valToAdd)
//    {
...
//    {
//#if defined(REX_COMPILER_MSVC)
//      return atomic_fetch_add_msvc(obj, valToAdd);
//#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
//      return atomic_fetch_add_clang(obj, valToAdd, rsl::memory_order::relaxed);
//#endif
//    }
...
//      return atomic_fetch_add_msvc(obj, valToAdd);
//#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
//      return atomic_fetch_add_clang(obj, valToAdd, rsl::memory_order::acquire);
//#endif
//    }
...
//      return atomic_fetch_add_msvc(obj, valToAdd);
//#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
//      return atomic_fetch_add_clang(obj, valToAdd, rsl::memory_order::release);
//#endif
//    }
...
//      return atomic_fetch_add_msvc(obj, valToAdd);
//#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
//      return atomic_fetch_add_clang(obj, valToAdd, rsl::memory_order::acq_rel);
//#endif
//    }
...
//      return atomic_fetch_add_msvc(obj, valToAdd);
//#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
//      return atomic_fetch_add_clang(obj, valToAdd, rsl::memory_order::seq_cst);
//#endif
//    }
//
//    // char8
