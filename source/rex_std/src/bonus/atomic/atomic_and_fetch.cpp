...
//    template <typename T>
//    atomic_t<T> atomic_and_fetch_msvc(T* obj, T valToAnd)
//    {
...
//    template <typename T>
//    atomic_t<T> atomic_and_fetch_clang(T* obj, T valToAnd, rsl::memory_order order)
//    {
...
//#endif
    ...
    uint8 atomic_and_fetch_acquire(uint8* obj, uint8 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    uint8 atomic_and_fetch_release(uint8* obj, uint8 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    uint8 atomic_and_fetch_acq_rel(uint8* obj, uint8 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    uint8 atomic_and_fetch_seq_cst(uint8* obj, uint8 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    // int8
    int8 atomic_and_fetch_relaxed(int8* obj, int8 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int8 atomic_and_fetch_acquire(int8* obj, int8 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int8 atomic_and_fetch_release(int8* obj, int8 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int8 atomic_and_fetch_acq_rel(int8* obj, int8 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int8 atomic_and_fetch_seq_cst(int8* obj, int8 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    // uint16
    uint16 atomic_and_fetch_relaxed(uint16* obj, uint16 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    uint16 atomic_and_fetch_acquire(uint16* obj, uint16 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    uint16 atomic_and_fetch_release(uint16* obj, uint16 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    uint16 atomic_and_fetch_acq_rel(uint16* obj, uint16 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    uint16 atomic_and_fetch_seq_cst(uint16* obj, uint16 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    // int16
    int16 atomic_and_fetch_relaxed(int16* obj, int16 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int16 atomic_and_fetch_acquire(int16* obj, int16 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int16 atomic_and_fetch_release(int16* obj, int16 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int16 atomic_and_fetch_acq_rel(int16* obj, int16 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int16 atomic_and_fetch_seq_cst(int16* obj, int16 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    // uint32
    uint32 atomic_and_fetch_relaxed(uint32* obj, uint32 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    uint32 atomic_and_fetch_acquire(uint32* obj, uint32 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    uint32 atomic_and_fetch_release(uint32* obj, uint32 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    uint32 atomic_and_fetch_acq_rel(uint32* obj, uint32 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    uint32 atomic_and_fetch_seq_cst(uint32* obj, uint32 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    // int32
    int32 atomic_and_fetch_relaxed(int32* obj, int32 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int32 atomic_and_fetch_acquire(int32* obj, int32 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int32 atomic_and_fetch_release(int32* obj, int32 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int32 atomic_and_fetch_acq_rel(int32* obj, int32 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int32 atomic_and_fetch_seq_cst(int32* obj, int32 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    // uint64
    uint64 atomic_and_fetch_relaxed(uint64* obj, uint64 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    uint64 atomic_and_fetch_acquire(uint64* obj, uint64 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    uint64 atomic_and_fetch_release(uint64* obj, uint64 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    uint64 atomic_and_fetch_acq_rel(uint64* obj, uint64 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    uint64 atomic_and_fetch_seq_cst(uint64* obj, uint64 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    // int64
    int64 atomic_and_fetch_relaxed(int64* obj, int64 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int64 atomic_and_fetch_acquire(int64* obj, int64 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int64 atomic_and_fetch_release(int64* obj, int64 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int64 atomic_and_fetch_acq_rel(int64* obj, int64 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
    ...
    int64 atomic_and_fetch_seq_cst(int64* obj, int64 valToAnd)
    {
#if defined(REX_COMPILER_MSVC)
      return atomic_and_fetch_msvc(obj, valToAnd);
#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
