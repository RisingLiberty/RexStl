...
//#endif
//
//    bool atomic_fetch_and(bool* obj, bool valToAdd, rsl::memory_order order)
//    {
//#if defined(REX_COMPILER_MSVC)
//      (void)order;
//      return atomic_fetch_and_msvc(obj, valToAdd);
//#elif defined(REX_COMPILER_GCC) || defined(REX_COMPILER_CLANG)
//      return atomic_fetch_and_clang(obj, valToAdd, order);
//#endif
//    }
//    char8 atomic_fetch_and(char8* obj, char8 valToAdd, rsl::memory_order order)
//    {
//#if defined(REX_COMPILER_MSVC)
//      (void)order;
//      return atomic_fetch_and_msvc(obj, valToAdd);
...
//#endif
//    }
//    uint8 atomic_fetch_and(uint8* obj, uint8 valToAdd, rsl::memory_order order)
//    {
//#if defined(REX_COMPILER_MSVC)
//      (void)order;
//      return atomic_fetch_and_msvc(obj, valToAdd);
...
//#endif
//    }
//    int8 atomic_fetch_and(int8* obj, int8 valToAdd, rsl::memory_order order)
//    {
//#if defined(REX_COMPILER_MSVC)
//      (void)order;
//      return atomic_fetch_and_msvc(obj, valToAdd);
...
//#endif
//    }
//    uint16 atomic_fetch_and(uint16* obj, uint16 valToAdd, rsl::memory_order order)
//    {
//#if defined(REX_COMPILER_MSVC)
//      (void)order;
//      return atomic_fetch_and_msvc(obj, valToAdd);
...
//#endif
//    }
//    int16 atomic_fetch_and(int16* obj, int16 valToAdd, rsl::memory_order order)
//    {
//#if defined(REX_COMPILER_MSVC)
//      (void)order;
//      return atomic_fetch_and_msvc(obj, valToAdd);
...
//#endif
//    }
//    uint32 atomic_fetch_and(uint32* obj, uint32 valToAdd, rsl::memory_order order)
//    {
//#if defined(REX_COMPILER_MSVC)
//      (void)order;
//      return atomic_fetch_and_msvc(obj, valToAdd);
...
//#endif
//    }
//    int32 atomic_fetch_and(int32* obj, int32 valToAdd, rsl::memory_order order)
//    {
//#if defined(REX_COMPILER_MSVC)
//      (void)order;
//      return atomic_fetch_and_msvc(obj, valToAdd);
...
//#endif
//    }
//    uint64 atomic_fetch_and(uint64* obj, uint64 valToAdd, rsl::memory_order order)
//    {
//#if defined(REX_COMPILER_MSVC)
//      (void)order;
//      return atomic_fetch_and_msvc(obj, valToAdd);
...
//#endif
//    }
//    int64 atomic_fetch_and(int64* obj, int64 valToAdd, rsl::memory_order order)
//    {
//#if defined(REX_COMPILER_MSVC)
//      (void)order;
//      return atomic_fetch_and_msvc(obj, valToAdd);
