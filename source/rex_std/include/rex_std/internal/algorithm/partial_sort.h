        ...
        if (rsl::less<value_type>()(*i, *first))
        {
          ...
          *i = rsl::forward<value_type>(*first);
          rsl::adjust_heap<RandomAccessIterator, difference_type, value_type>
            (first, difference_type(0), difference_type(middle - first), difference_type(0), rsl::forward<value_type>(temp));
        }
      }
        ...
        if (compare(*i, *first))
        {
          ...
          *i = rsl::forward<value_type>(*first);
          rsl::adjust_heap<RandomAccessIterator, difference_type, value_type, Compare>
            (first, difference_type(0), difference_type(middle - first), difference_type(0), rsl::forward<value_type>(temp), compare);
        }
      }
