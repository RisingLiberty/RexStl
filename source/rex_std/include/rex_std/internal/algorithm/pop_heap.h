  ...
  inline namespace v1
  {
    ...
    void pop_heap(RandomAccessIterator first, RandomAccessIterator last)
    {
      ...
      *(last - 1) = rsl::forward<value_type>(*first);
      rsl::adjust_heap<RandomAccessIterator, difference_type, value_type>(first, (difference_type)0, (difference_type)(last - first - 1), 0, rsl::forward<value_type>(temp_bottom));
    }
    ...
    void pop_heap(RandomAccessIterator first, RandomAccessIterator last, Compare compare)
    {
      ...
      value_type temp_bottom(rsl::forward<value_type>(*(last - 1)));
      *(last - 1) = rsl::forward<value_type>(*first);
      rsl::adjust_heap<RandomAccessIterator, difference_type, value_type, Compare>(first, (difference_type)0, (difference_type)(last - first - 1), 0, rsl::forward<value_type>(temp_bottom), compare);
    }
  } // namespace v1
} // namespace rsl
