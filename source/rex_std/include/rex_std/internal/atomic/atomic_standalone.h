...
//
template <typename T>
REX_FORCE_INLINE bool atomic_compare_exchange_strong(rsl::atomic<T>* atomicObj,
													   typename rsl::atomic<T>::value_type* expected,
													   typename rsl::atomic<T>::value_type desired)
{
	return atomicObj->compare_exchange_strong(*expected, desired);
}

template <typename T, typename OrderSuccess, typename OrderFailure>
REX_FORCE_INLINE bool atomic_compare_exchange_strong_explicit(rsl::atomic<T>* atomicObj,
																typename rsl::atomic<T>::value_type* expected,
																typename rsl::atomic<T>::value_type desired,
																OrderSuccess orderSuccess, OrderFailure orderFailure)
{
...
//
template <typename T>
REX_FORCE_INLINE bool atomic_compare_exchange_weak(rsl::atomic<T>* atomicObj,
													 typename rsl::atomic<T>::value_type* expected,
													 typename rsl::atomic<T>::value_type desired)
{
...
template <typename T, typename OrderSuccess, typename OrderFailure>
REX_FORCE_INLINE bool atomic_compare_exchange_weak_explicit(rsl::atomic<T>* atomicObj,
															  typename rsl::atomic<T>::value_type* expected,
															  typename rsl::atomic<T>::value_type desired,
															  OrderSuccess orderSuccess, OrderFailure orderFailure)
{
...
//
template <typename T>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_fetch_xor(rsl::atomic<T>* atomicObj,
																		  typename rsl::atomic<T>::value_type arg)
{
	return atomicObj->fetch_xor(arg);
}

template <typename T, typename Order>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_fetch_xor_explicit(rsl::atomic<T>* atomicObj,
																				   typename rsl::atomic<T>::value_type arg,
																				   Order order)
{
...
//
template <typename T>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_xor_fetch(rsl::atomic<T>* atomicObj,
																		  typename rsl::atomic<T>::value_type arg)
{
...
template <typename T, typename Order>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_xor_fetch_explicit(rsl::atomic<T>* atomicObj,
																				   typename rsl::atomic<T>::value_type arg,
																				   Order order)
{
...
//
template <typename T>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_fetch_or(rsl::atomic<T>* atomicObj,
																		 typename rsl::atomic<T>::value_type arg)
{
...
template <typename T, typename Order>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_fetch_or_explicit(rsl::atomic<T>* atomicObj,
																				  typename rsl::atomic<T>::value_type arg,
																				  Order order)
{
...
//
template <typename T>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_or_fetch(rsl::atomic<T>* atomicObj,
																		 typename rsl::atomic<T>::value_type arg)
{
...
template <typename T, typename Order>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_or_fetch_explicit(rsl::atomic<T>* atomicObj,
																				  typename rsl::atomic<T>::value_type arg,
																				  Order order)
{
...
//
template <typename T>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_fetch_and(rsl::atomic<T>* atomicObj,
																		  typename rsl::atomic<T>::value_type arg)
{
...
template <typename T, typename Order>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_fetch_and_explicit(rsl::atomic<T>* atomicObj,
																				   typename rsl::atomic<T>::value_type arg,
																				   Order order)
{
...
//
template <typename T>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_and_fetch(rsl::atomic<T>* atomicObj,
																		  typename rsl::atomic<T>::value_type arg)
{
...
template <typename T, typename Order>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_and_fetch_explicit(rsl::atomic<T>* atomicObj,
																				   typename rsl::atomic<T>::value_type arg,
																				   Order order)
{
...
//
template <typename T>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_fetch_sub(rsl::atomic<T>* atomicObj,
																		  typename rsl::atomic<T>::difference_type arg)
{
	return atomicObj->fetch_sub(arg);
}

template <typename T, typename Order>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_fetch_sub_explicit(rsl::atomic<T>* atomicObj,
																				   typename rsl::atomic<T>::difference_type arg,
																				   Order order)
{
...
//
template <typename T>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_sub_fetch(rsl::atomic<T>* atomicObj,
																		  typename rsl::atomic<T>::difference_type arg)
{
...
template <typename T, typename Order>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_sub_fetch_explicit(rsl::atomic<T>* atomicObj,
																				   typename rsl::atomic<T>::difference_type arg,
																				   Order order)
{
...
//
template <typename T>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_fetch_add(rsl::atomic<T>* atomicObj,
																		  typename rsl::atomic<T>::difference_type arg)
{
...
template <typename T, typename Order>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_fetch_add_explicit(rsl::atomic<T>* atomicObj,
																				   typename rsl::atomic<T>::difference_type arg,
																				   Order order)
{
...
//
template <typename T>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_add_fetch(rsl::atomic<T>* atomicObj,
																		  typename rsl::atomic<T>::difference_type arg)
{
...
template <typename T, typename Order>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_add_fetch_explicit(rsl::atomic<T>* atomicObj,
																				   typename rsl::atomic<T>::difference_type arg,
																				   Order order)
{
...
//
template <typename T>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_exchange(rsl::atomic<T>* atomicObj,
																		 typename rsl::atomic<T>::value_type desired)
{
...
template <typename T, typename Order>
REX_FORCE_INLINE typename rsl::atomic<T>::value_type atomic_exchange_explicit(rsl::atomic<T>* atomicObj,
																				  typename rsl::atomic<T>::value_type desired,
																				  Order order)
{
...
{
	REX_ATOMIC_COMPILER_BARRIER_DATA_DEPENDENCY(val, T);
}
