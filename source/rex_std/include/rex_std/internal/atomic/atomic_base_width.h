...
#define REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits) MERGE(REX_ATOMIC_FIXED_WIDTH_TYPE_, bits)
...
#define REX_ATOMIC_STORE_FUNC_IMPL(op, bits)                                                                                                                                                                                                             \
  ...
  MERGE(op, bits)(REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits), REX_ATOMIC_TYPE_CAST(REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits), this->GetAtomicAddress()), fixedWidthDesired)

#define REX_ATOMIC_LOAD_FUNC_IMPL(op, bits)                                                                                                                                                                                                              \
  REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits) retVal;                                                                                                                                                                                                         \
  MERGE(op, bits)(REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits), retVal, REX_ATOMIC_TYPE_CAST(REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits), this->GetAtomicAddress()));                                                                                               \
  return REX_ATOMIC_TYPE_PUN_CAST(T, retVal);

#define REX_ATOMIC_EXCHANGE_FUNC_IMPL(op, bits)                                                                                                                                                                                                          \
  REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits) retVal;                                                                                                                                                                                                         \
  REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits) fixedWidthDesired = REX_ATOMIC_TYPE_PUN_CAST(REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits), desired);                                                                                                                  \
  MERGE(op, bits)(REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits), retVal, REX_ATOMIC_TYPE_CAST(REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits), this->GetAtomicAddress()), fixedWidthDesired);                                                                            \
  return REX_ATOMIC_TYPE_PUN_CAST(T, retVal);

#define REX_ATOMIC_CMPXCHG_FUNC_IMPL(op, bits)                                                                                                                                                                                                           \
  bool retVal;                                                                                                                                                                                                                                           \
  REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits) fixedWidthDesired = REX_ATOMIC_TYPE_PUN_CAST(REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits), desired);                                                                                                                  \
  MERGE(op, bits)(REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits), retVal, REX_ATOMIC_TYPE_CAST(REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits), this->GetAtomicAddress()), REX_ATOMIC_TYPE_CAST(REX_ATOMIC_BASE_FIXED_WIDTH_TYPE(bits), &expected), fixedWidthDesired);   \
  return retVal;

#define REX_ATOMIC_BASE_OP_JOIN(op, Order) MERGE(MERGE(REX_ATOMIC_, op), Order)
...
#define REX_ATOMIC_BASE_CMPXCHG_FUNCS_IMPL(funcName, cmpxchgOp, bits)                                                                                                                                                                                    \
  ...
  {                                                                                                                                                                                                                                                      \
    REX_ATOMIC_CMPXCHG_FUNC_IMPL(REX_ATOMIC_BASE_OP_JOIN(cmpxchgOp, _SEQ_CST_), bits);                                                                                                                                                                   \
                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                         \
  bool funcName(T& expected, T desired, rsl::internal::memory_order_relaxed_s)                                                                                                                                                                           \
  {                                                                                                                                                                                                                                                      \
    REX_ATOMIC_CMPXCHG_FUNC_IMPL(REX_ATOMIC_BASE_OP_JOIN(cmpxchgOp, _RELAXED_), bits);                                                                                                                                                                   \
  }                                                                                                                                                                                                                                                      \
                                                                                                                                                                                                                                                         \
  bool funcName(T& expected, T desired, rsl::internal::memory_order_acquire_s)                                                                                                                                                                           \
  {                                                                                                                                                                                                                                                      \
    REX_ATOMIC_CMPXCHG_FUNC_IMPL(REX_ATOMIC_BASE_OP_JOIN(cmpxchgOp, _ACQUIRE_), bits);                                                                                                                                                                   \
  }                                                                                                                                                                                                                                                      \
                                                                                                                                                                                                                                                         \
  bool funcName(T& expected, T desired, rsl::internal::memory_order_release_s)                                                                                                                                                                           \
  {                                                                                                                                                                                                                                                      \
    REX_ATOMIC_CMPXCHG_FUNC_IMPL(REX_ATOMIC_BASE_OP_JOIN(cmpxchgOp, _RELEASE_), bits);                                                                                                                                                                   \
  }                                                                                                                                                                                                                                                      \
                                                                                                                                                                                                                                                         \
  bool funcName(T& expected, T desired, rsl::internal::memory_order_acq_rel_s)                                                                                                                                                                           \
  {                                                                                                                                                                                                                                                      \
    REX_ATOMIC_CMPXCHG_FUNC_IMPL(REX_ATOMIC_BASE_OP_JOIN(cmpxchgOp, _ACQ_REL_), bits);                                                                                                                                                                   \
  }                                                                                                                                                                                                                                                      \
                                                                                                                                                                                                                                                         \
  bool funcName(T& expected, T desired, rsl::internal::memory_order_seq_cst_s)                                                                                                                                                                           \
  {                                                                                                                                                                                                                                                      \
    REX_ATOMIC_CMPXCHG_FUNC_IMPL(REX_ATOMIC_BASE_OP_JOIN(cmpxchgOp, _SEQ_CST_), bits);                                                                                                                                                                   \
  }                                                                                                                                                                                                                                                      \
                                                                                                                                                                                                                                                         \
  bool funcName(T& expected, T desired, rsl::internal::memory_order_relaxed_s, rsl::internal::memory_order_relaxed_s)                                                                                                                                    \
  {                                                                                                                                                                                                                                                      \
    REX_ATOMIC_CMPXCHG_FUNC_IMPL(REX_ATOMIC_BASE_OP_JOIN(cmpxchgOp, _RELAXED_RELAXED_), bits);                                                                                                                                                           \
  }                                                                                                                                                                                                                                                      \
                                                                                                                                                                                                                                                         \
  bool funcName(T& expected, T desired, rsl::internal::memory_order_acquire_s, rsl::internal::memory_order_relaxed_s)                                                                                                                                    \
  {                                                                                                                                                                                                                                                      \
    REX_ATOMIC_CMPXCHG_FUNC_IMPL(REX_ATOMIC_BASE_OP_JOIN(cmpxchgOp, _ACQUIRE_RELAXED_), bits);                                                                                                                                                           \
  }                                                                                                                                                                                                                                                      \
                                                                                                                                                                                                                                                         \
  bool funcName(T& expected, T desired, rsl::internal::memory_order_acquire_s, rsl::internal::memory_order_acquire_s)                                                                                                                                    \
  {                                                                                                                                                                                                                                                      \
    REX_ATOMIC_CMPXCHG_FUNC_IMPL(REX_ATOMIC_BASE_OP_JOIN(cmpxchgOp, _ACQUIRE_ACQUIRE_), bits);                                                                                                                                                           \
  }                                                                                                                                                                                                                                                      \
                                                                                                                                                                                                                                                         \
  bool funcName(T& expected, T desired, rsl::internal::memory_order_release_s, rsl::internal::memory_order_relaxed_s)                                                                                                                                    \
  {                                                                                                                                                                                                                                                      \
    REX_ATOMIC_CMPXCHG_FUNC_IMPL(REX_ATOMIC_BASE_OP_JOIN(cmpxchgOp, _RELEASE_RELAXED_), bits);                                                                                                                                                           \
  }                                                                                                                                                                                                                                                      \
                                                                                                                                                                                                                                                         \
  bool funcName(T& expected, T desired, rsl::internal::memory_order_acq_rel_s, rsl::internal::memory_order_relaxed_s)                                                                                                                                    \
  {                                                                                                                                                                                                                                                      \
    REX_ATOMIC_CMPXCHG_FUNC_IMPL(REX_ATOMIC_BASE_OP_JOIN(cmpxchgOp, _ACQ_REL_RELAXED_), bits);                                                                                                                                                           \
  }                                                                                                                                                                                                                                                      \
                                                                                                                                                                                                                                                         \
  bool funcName(T& expected, T desired, rsl::internal::memory_order_acq_rel_s, rsl::internal::memory_order_acquire_s)                                                                                                                                    \
  {                                                                                                                                                                                                                                                      \
    REX_ATOMIC_CMPXCHG_FUNC_IMPL(REX_ATOMIC_BASE_OP_JOIN(cmpxchgOp, _ACQ_REL_ACQUIRE_), bits);                                                                                                                                                           \
  }                                                                                                                                                                                                                                                      \
                                                                                                                                                                                                                                                         \
  bool funcName(T& expected, T desired, rsl::internal::memory_order_seq_cst_s, rsl::internal::memory_order_relaxed_s)                                                                                                                                    \
  {                                                                                                                                                                                                                                                      \
    REX_ATOMIC_CMPXCHG_FUNC_IMPL(REX_ATOMIC_BASE_OP_JOIN(cmpxchgOp, _SEQ_CST_RELAXED_), bits);                                                                                                                                                           \
  }                                                                                                                                                                                                                                                      \
                                                                                                                                                                                                                                                         \
  bool funcName(T& expected, T desired, rsl::internal::memory_order_seq_cst_s, rsl::internal::memory_order_acquire_s)                                                                                                                                    \
  {                                                                                                                                                                                                                                                      \
    REX_ATOMIC_CMPXCHG_FUNC_IMPL(REX_ATOMIC_BASE_OP_JOIN(cmpxchgOp, _SEQ_CST_ACQUIRE_), bits);                                                                                                                                                           \
  }                                                                                                                                                                                                                                                      \
                                                                                                                                                                                                                                                         \
  bool funcName(T& expected, T desired, rsl::internal::memory_order_seq_cst_s, rsl::internal::memory_order_seq_cst_s)                                                                                                                                    \
  {                                                                                                                                                                                                                                                      \
    REX_ATOMIC_CMPXCHG_FUNC_IMPL(REX_ATOMIC_BASE_OP_JOIN(cmpxchgOp, _SEQ_CST_SEQ_CST_), bits);                                                                                                                                                           \
  }

#define REX_ATOMIC_BASE_CMPXCHG_WEAK_FUNCS_IMPL(bits) REX_ATOMIC_BASE_CMPXCHG_FUNCS_IMPL(compare_exchange_weak, CMPXCHG_WEAK, bits)

#define REX_ATOMIC_BASE_CMPXCHG_STRONG_FUNCS_IMPL(bits) REX_ATOMIC_BASE_CMPXCHG_FUNCS_IMPL(compare_exchange_strong, CMPXCHG_STRONG, bits)
