...
#define REX_ATOMIC_POINTER_FETCH_OP_JOIN(fetchOp, Order)				\
...
#define REX_ATOMIC_POINTER_FETCH_FUNCS_IMPL(funcName, fetchOp, bits)	\
	...
	REX_ATOMIC_POINTER_FETCH_IMPL(funcName, REX_ATOMIC_POINTER_FETCH_OP_JOIN(fetchOp, _SEQ_CST_), bits) \
																		\
	REX_ATOMIC_POINTER_FETCH_ORDER_IMPL(funcName, rsl::internal::memory_order_relaxed_s, \
										  REX_ATOMIC_POINTER_FETCH_OP_JOIN(fetchOp, _RELAXED_), bits) \
																		\
	REX_ATOMIC_POINTER_FETCH_ORDER_IMPL(funcName, rsl::internal::memory_order_acquire_s, \
										  REX_ATOMIC_POINTER_FETCH_OP_JOIN(fetchOp, _ACQUIRE_), bits) \
																		\
	REX_ATOMIC_POINTER_FETCH_ORDER_IMPL(funcName, rsl::internal::memory_order_release_s, \
										  REX_ATOMIC_POINTER_FETCH_OP_JOIN(fetchOp, _RELEASE_), bits) \
																		\
	REX_ATOMIC_POINTER_FETCH_ORDER_IMPL(funcName, rsl::internal::memory_order_acq_rel_s, \
										  REX_ATOMIC_POINTER_FETCH_OP_JOIN(fetchOp, _ACQ_REL_), bits) \
																		\
	REX_ATOMIC_POINTER_FETCH_ORDER_IMPL(funcName, rsl::internal::memory_order_seq_cst_s, \
										  REX_ATOMIC_POINTER_FETCH_OP_JOIN(fetchOp, _SEQ_CST_), bits)
