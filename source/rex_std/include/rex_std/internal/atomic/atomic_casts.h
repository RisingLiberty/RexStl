 ...
 */
#define REX_ATOMIC_VOLATILE_CAST(ptr)			\
	rsl::internal::AtomicVolatileCast((ptr))

#define REX_ATOMIC_VOLATILE_INTEGRAL_CAST(IntegralType, ptr)		\
	rsl::internal::AtomicVolatileIntegralCast<IntegralType>((ptr))

#define REX_ATOMIC_INTEGRAL_CAST(IntegralType, ptr)		\
	rsl::internal::AtomicIntegralCast<IntegralType>((ptr))

#define REX_ATOMIC_VOLATILE_TYPE_CAST(ToType, ptr)		\
	rsl::internal::AtomicVolatileTypeCast<ToType>((ptr))

#define REX_ATOMIC_TYPE_CAST(ToType, ptr)			\
	rsl::internal::AtomicTypeCast<ToType>((ptr))

#define REX_ATOMIC_TYPE_PUN_CAST(PunType, fromType)		\
	rsl::internal::AtomicTypePunCast<PunType>((fromType))

#define REX_ATOMIC_NEGATE_OPERAND(val)		\
	rsl::internal::AtomicNegateOperand((val))
