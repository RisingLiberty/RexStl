...
//
#define REX_ATOMIC_COMPILER_BARRIER()						\
	REX_ATOMIC_CHOOSE_OP_IMPL(ATOMIC_COMPILER_BARRIER)()
...
//
#define REX_ATOMIC_COMPILER_BARRIER_DATA_DEPENDENCY(val, type)		\
	REX_ATOMIC_CHOOSE_OP_IMPL(ATOMIC_COMPILER_BARRIER_DATA_DEPENDENCY)(val, type)
