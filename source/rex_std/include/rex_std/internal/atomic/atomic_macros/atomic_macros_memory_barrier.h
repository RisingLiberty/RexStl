...
//
#define REX_ATOMIC_CPU_MB()						\
	REX_ATOMIC_CHOOSE_OP_IMPL(ATOMIC_CPU_MB)()
...
//
#define REX_ATOMIC_CPU_WMB()						\
	REX_ATOMIC_CHOOSE_OP_IMPL(ATOMIC_CPU_WMB)()
...
//
#define REX_ATOMIC_CPU_RMB()						\
	REX_ATOMIC_CHOOSE_OP_IMPL(ATOMIC_CPU_RMB)()
