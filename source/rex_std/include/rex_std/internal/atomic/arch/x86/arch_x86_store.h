...
//
	...
	#define REX_ARCH_ATOMIC_X86_STORE_8(type, ptr, val)			\
		REX_ARCH_ATOMIC_X86_STORE_N(__int8, 8, type, ptr, val)

	#define REX_ARCH_ATOMIC_X86_STORE_16(type, ptr, val)			\
		REX_ARCH_ATOMIC_X86_STORE_N(__int16, 16, type, ptr, val)

	#define REX_ARCH_ATOMIC_X86_STORE_32(type, ptr, val)			\
		REX_ARCH_ATOMIC_X86_STORE_N(__int32, 32, type, ptr, val)

	#define REX_ARCH_ATOMIC_X86_STORE_64(type, ptr, val)			\
		REX_ARCH_ATOMIC_X86_STORE_N(__int64, 64, type, ptr, val)
	...
	#define REX_ARCH_ATOMIC_STORE_RELAXED_128(type, ptr, val)		\
		REX_ARCH_ATOMIC_X86_STORE_128(type, ptr, val, RELAXED)
	 ...
	 */
		...
		#define REX_ARCH_ATOMIC_STORE_SEQ_CST_64(type, ptr, val)		\
			{															\
				type exchange64; (void)(exchange64);					\
	...
	#define REX_ARCH_ATOMIC_STORE_SEQ_CST_128(type, ptr, val)		\
		REX_ARCH_ATOMIC_X86_STORE_128(type, ptr, val, SEQ_CST)
