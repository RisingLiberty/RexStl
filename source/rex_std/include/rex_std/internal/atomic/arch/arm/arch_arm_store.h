...
//
  ...
  #define REX_ARCH_ATOMIC_ARM_STORE_N(integralType, bits, type, ptr, val) MERGE(__iso_volatile_store, bits)(REX_ATOMIC_VOLATILE_INTEGRAL_CAST(integralType, (ptr)), REX_ATOMIC_TYPE_PUN_CAST(integralType, (val)))

  #define REX_ARCH_ATOMIC_ARM_STORE_8(type, ptr, val) REX_ARCH_ATOMIC_ARM_STORE_N(__int8, 8, type, ptr, val)

  #define REX_ARCH_ATOMIC_ARM_STORE_16(type, ptr, val) REX_ARCH_ATOMIC_ARM_STORE_N(__int16, 16, type, ptr, val)

  #define REX_ARCH_ATOMIC_ARM_STORE_32(type, ptr, val) REX_ARCH_ATOMIC_ARM_STORE_N(__int32, 32, type, ptr, val)

  #if defined(REX_PLATFORM_ARM64)

    #define REX_ARCH_ATOMIC_ARM_STORE_64(type, ptr, val) REX_ARCH_ATOMIC_ARM_STORE_N(__int64, 64, type, ptr, val)
  ...
  #define REX_ARCH_ATOMIC_STORE_RELAXED_8(type, ptr, val) REX_ARCH_ATOMIC_ARM_STORE_8(type, ptr, val)

  #define REX_ARCH_ATOMIC_STORE_RELAXED_16(type, ptr, val) REX_ARCH_ATOMIC_ARM_STORE_16(type, ptr, val)

  #define REX_ARCH_ATOMIC_STORE_RELAXED_32(type, ptr, val) REX_ARCH_ATOMIC_ARM_STORE_32(type, ptr, val)
