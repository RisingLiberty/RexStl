...
#pragma once
	...
	#define REX_ARCH_ATOMIC_ARM_EMIT_DMB(option)										\
		__asm__ __volatile__ ("dmb " STRINGIZE(option) ::: "memory")
...
#define REX_ARCH_ATOMIC_CPU_MB()				\
	REX_ARCH_ATOMIC_ARM_EMIT_DMB(REX_ARM_DMB_ISH)
...
//
#define REX_ARCH_ATOMIC_CPU_WMB()				\
	REX_ARCH_ATOMIC_ARM_EMIT_DMB(REX_ARM_DMB_ISHST)
...
//
#define REX_ARCH_ATOMIC_CPU_RMB()				\
	REX_ARCH_ATOMIC_ARM_EMIT_DMB(REX_ARM_DMB_ISHLD)
