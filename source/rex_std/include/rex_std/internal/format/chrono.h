...
// Enable safe chrono durations, unless explicitly disabled.
  ...
  #define FMT_SAFE_DURATION_CAST 1
    ...
    namespace safe_duration_cast
    {
      ...
      template <typename To, typename From, FMT_ENABLE_IF(!rsl::is_same<From, To>::value && rsl::numeric_limits<From>::is_signed == rsl::numeric_limits<To>::is_signed)>
      ...
      template <typename To, typename From, FMT_ENABLE_IF(rsl::is_same<From, To>::value)>
      FMT_CONSTEXPR To lossless_integral_conversion(const From from, int& ec)
      {
        ec = 0;
        return from;
 ...
 */
       ...
       */
      template <typename To, typename FromRep, typename FromPeriod, FMT_ENABLE_IF(rsl::is_integral<FromRep>::value), FMT_ENABLE_IF(rsl::is_integral<typename To::rep>::value)>
      To safe_duration_cast(rsl::chrono::duration<FromRep, FromPeriod> from, int& ec)
      {
        using From = rsl::chrono::duration<FromRep, FromPeriod>;
        ec         = 0;
        // the basic idea is that we need to convert from count() in the from type
        // to count() in the To type, by multiplying it with this:
        struct Factor : rsl::ratio_divide<typename From::period, typename To::period>
        {
        };
        ...
        using IntermediateRep = typename rsl::common_type<typename From::rep, typename To::rep, decltype(Factor::num)>::type;
        ...
        if(detail::const_check(Factor::num != 1))
        {
          ...
          const auto min1 = (rsl::numeric_limits<IntermediateRep>::min)() / Factor::num;
       ...
       */
      template <typename To, typename FromRep, typename FromPeriod, FMT_ENABLE_IF(rsl::is_floating_point<FromRep>::value), FMT_ENABLE_IF(rsl::is_floating_point<typename To::rep>::value)>
      To safe_duration_cast(rsl::chrono::duration<FromRep, FromPeriod> from, int& ec)
      {
        using From = rsl::chrono::duration<FromRep, FromPeriod>;
        ec         = 0;
        ...
        if(detail::const_check(Factor::num != 1))
        {
          ...
          constexpr auto min1 = rsl::numeric_limits<IntermediateRep>::lowest() / static_cast<IntermediateRep>(Factor::num);
          if(count < min1)
          {
            ec = 1;
            return {};
...
#define FMT_NOMACRO
    ...
    namespace detail
    {
      ...
      template <typename CodeUnit>
      void write_codecvt(codecvt_result<CodeUnit>& out, string_view in_buf, const rsl::locale& loc)
      {
  ...
  #pragma clang diagnostic pop
        ...
        auto result           = f.in(mb, in_buf.begin(), in_buf.end(), from_next, rsl::begin(out.buf), rsl::end(out.buf), out.end);
        if(result != rsl::codecvt_base::ok)
          FMT_THROW(format_error("failed to format time"));
      }

      template <typename OutputIt>
      auto write_encoded_tm_str(OutputIt out, string_view in, const rsl::locale& loc) -> OutputIt
      {
      ...
      template <typename Char, typename OutputIt, FMT_ENABLE_IF(!rsl::is_same<Char, char>::value)>
      auto write_tm_str(OutputIt out, string_view sv, const rsl::locale& loc) -> OutputIt
      {
      ...
      inline void do_write(buffer<Char>& buf, const rsl::tm& time, const rsl::locale& loc, char format, char modifier)
      {
      ...
      template <typename Char, typename OutputIt, FMT_ENABLE_IF(!rsl::is_same<Char, char>::value)>
      auto write(OutputIt out, const rsl::tm& time, const rsl::locale& loc, char format, char modifier = 0) -> OutputIt
      {
          ...
          using namespace rsl
          {
            ...
            bool handle(detail::null<>)
            {
              using namespace rsl
              {
                ...
                {
                  using namespace rsl {inline namespace v1 {::detail;
            ...
            inline rsl::tm localtime(rsl::chrono::time_point<rsl::chrono::system_clock> time_point)
            {
              ...
              struct dispatcher
              {
                ...
                bool run()
                {
                  using namespace rsl
                  {
                    ...
                    inline rsl::tm gmtime(rsl::chrono::time_point<rsl::chrono::system_clock> time_point)
                    {
                    ...
                    namespace detail
                    {
                      ...
                      {
                        if(rsl::is_same<Period, rsl::atto>::value)
                          return "as";
                        if(rsl::is_same<Period, rsl::femto>::value)
                          return "fs";
                        if(rsl::is_same<Period, rsl::pico>::value)
                          return "ps";
                        if(rsl::is_same<Period, rsl::nano>::value)
                          return "ns";
                        if(rsl::is_same<Period, rsl::micro>::value)
                          return "µs";
                        if(rsl::is_same<Period, rsl::milli>::value)
                          return "ms";
                        if(rsl::is_same<Period, rsl::centi>::value)
                          return "cs";
                        if(rsl::is_same<Period, rsl::deci>::value)
                          return "ds";
                        if(rsl::is_same<Period, rsl::ratio<1>>::value)
                          return "s";
                        if(rsl::is_same<Period, rsl::deca>::value)
                          return "das";
                        if(rsl::is_same<Period, rsl::hecto>::value)
                          return "hs";
                        if(rsl::is_same<Period, rsl::kilo>::value)
                          return "ks";
                        if(rsl::is_same<Period, rsl::mega>::value)
                          return "Ms";
                        if(rsl::is_same<Period, rsl::giga>::value)
                          return "Gs";
                        if(rsl::is_same<Period, rsl::tera>::value)
                          return "Ts";
                        if(rsl::is_same<Period, rsl::peta>::value)
                          return "Ps";
                        if(rsl::is_same<Period, rsl::exa>::value)
                          return "Es";
                        if(rsl::is_same<Period, rsl::ratio<60>>::value)
                          return "m";
                        if(rsl::is_same<Period, rsl::ratio<3600>>::value)
                          return "h";
                        return nullptr;
                      }
                      ...
                      template <typename T>
                      struct has_member_data_tm_gmtoff<T, void_t<decltype(T::tm_gmtoff)>> : rsl::true_type
                      {
                      };
                      ...
                      template <typename T>
                      struct has_member_data_tm_zone<T, void_t<decltype(T::tm_zone)>> : rsl::true_type
                      {
                      };
                      ...
                      private:
                        ...
                        void write_year_extended(long long year)
                        {
                          ...
                          if(width > num_digits)
                            out_ = rsl::fill_n(out_, width - num_digits, '0');
                      ...
                      {
                        FMT_ASSERT(rsl::is_unsigned<Int>::value || (value >= 0 && to_unsigned(value) <= to_unsigned(upper)), "invalid value");
                        (void)upper;
                      ...
                      template <typename Rep, typename Period, FMT_ENABLE_IF(rsl::is_integral<Rep>::value)>
                      inline rsl::chrono::duration<Rep, rsl::milli> get_milliseconds(rsl::chrono::duration<Rep, Period> d)
                      {
                        // this may overflow and/or the result may not fit in the
                        // target type.
#if FMT_SAFE_DURATION_CAST
                        using CommonSecondsType       = typename rsl::common_type<decltype(d), rsl::chrono::seconds>::type;
                        const auto d_as_common        = fmt_safe_duration_cast<CommonSecondsType>(d);
                        const auto d_as_whole_seconds = fmt_safe_duration_cast<rsl::chrono::seconds>(d_as_common);
                        // this conversion should be nonproblematic
                        const auto diff = d_as_common - d_as_whole_seconds;
                        const auto ms   = fmt_safe_duration_cast<rsl::chrono::duration<Rep, rsl::milli>>(diff);
                        return ms;
#else
                      ...
                      template <class Rep, class Period, FMT_ENABLE_IF(rsl::numeric_limits<Rep>::is_signed)>
                      constexpr rsl::chrono::duration<Rep, Period> abs(rsl::chrono::duration<Rep, Period> d)
                      {
                      ...
                      template <typename Char, typename Rep, typename OutputIt, FMT_ENABLE_IF(rsl::is_integral<Rep>::value)>
                      OutputIt format_duration_value(OutputIt out, Rep val, int)
                      {
                        return write<Char>(out, val);
                      }

                      template <typename Char, typename Rep, typename OutputIt, FMT_ENABLE_IF(rsl::is_floating_point<Rep>::value)>
                      ...
                      struct chrono_formatter
                      {
                        ...
                        using rep = conditional_t<rsl::is_integral<Rep>::value && sizeof(Rep) < sizeof(int), unsigned, typename make_unsigned_or_unchanged<Rep>::type>;
                        rep val;
                        ...
                        chrono_formatter(FormatContext& ctx, OutputIt o, rsl::chrono::duration<Rep, Period> d)
                            : context(ctx)
                            , out(o)
...
#else
                          s = rsl::chrono::duration_cast<seconds>(rsl::chrono::duration<rep, Period>(val));
#endif
                        }
                        ...
                        void write(Rep value, int width)
                        {
                          ...
                          if(width > num_digits)
                            out = rsl::fill_n(out, width - num_digits, '0');
                        ...
                        void write_fractional_seconds(Duration d)
                        {
                          ...
                          using subsecond_precision = rsl::chrono::duration<typename rsl::common_type<typename Duration::rep, rsl::chrono::seconds::rep>::type, rsl::ratio<1, detail::pow10(num_fractional_digits)>>;
                          if(rsl::ratio_less<typename subsecond_precision::period, rsl::chrono::seconds::period>::value)
                          {
                            *out++                             = '.';
                            auto fractional                    = detail::abs(d) - rsl::chrono::duration_cast<rsl::chrono::seconds>(d);
                            auto subseconds                    = rsl::chrono::treat_as_floating_point<typename subsecond_precision::rep>::value ? fractional.count() : rsl::chrono::duration_cast<subsecond_precision>(fractional).count();
                        ...
                        void write_nan()
                        {
                          rsl::copy_n("nan", 3, out);
                        }
                        void write_pinf()
                        {
                          rsl::copy_n("inf", 3, out);
                        }
                        void write_ninf()
                        {
                          rsl::copy_n("-inf", 4, out);
                        }
                        ...
                        void on_second(numeric_system ns)
                        {
                          ...
                          if(ns == numeric_system::standard)
                          {
                            if(rsl::is_floating_point<rep>::value)
                            {
                              ...
                              format_to(rsl::back_inserter(buf), runtime("{:.{}f}"), rsl::fmod(val * static_cast<rep>(Period::num) / static_cast<rep>(Period::den), static_cast<rep>(60)), num_fractional_digits);
                              if(negative)
                                *out++ = '-';
                              if(buf.size() < 2 || buf[1] == '.')
                                *out++ = '0';
                    ...
                    struct formatter<rsl::chrono::time_point<rsl::chrono::system_clock, Duration>, Char> : formatter<rsl::tm, Char>
                    {
                      ...
                      template <typename FormatContext>
                      auto format(rsl::chrono::time_point<rsl::chrono::system_clock> val, FormatContext& ctx) const -> decltype(ctx.out())
                      {
                    ...
                    public:
                      ...
                      template <typename FormatContext>
                      auto format(const rsl::tm& tm, FormatContext& ctx) const -> decltype(ctx.out())
                      {
