  ...
  inline namespace v1
  {
    ...
    namespace detail
    {
      ...
      inline void reset_color(buffer<Char>& buffer)
      {
        ...
        buffer.append(rsl::iterator_to_pointer(reset_color.begin()), rsl::iterator_to_pointer(reset_color.end()));
      }
    ...
    // void print(rsl::FILE* f, const text_style& ts, const S& format_str, const Args&... args)
    //{
    //   vprint(f, ts, format_str, rsl::make_format_args<buffer_context<char_t<S>>>(args...));
    // }
    ...
    inline rsl::fmt_stack_string vformat(const text_style& ts, const S& format_str, basic_format_args<buffer_context<type_identity_t<Char>>> args)
    {
      ...
      return rsl::fmt_stack_string(buf.data(), buf.size());
    }
    ...
    */
    ...
    inline auto format_to(OutputIt out, const text_style& ts, const S& format_str, Args&&... args) -> typename rsl::enable_if<enable, OutputIt>::type
    {
      return vformat_to(out, ts, detail::to_string_view(format_str), rsl::make_format_args<buffer_context<char_t<S>>>(args...));
    }
