  ...
  inline namespace v1
  {
    namespace string_utils
    {
      ...
      namespace internal
      {
        ...
        constexpr rsl::optional<T> str_to_signed(Iterator str, int32 base);
        ...
        template <typename T, typename Iterator>
        constexpr rsl::optional<T> str_to_bool(Iterator str);
        ...
        template <typename Iterator>
        constexpr rsl::optional<void*> str_to_pointer(Iterator str);
