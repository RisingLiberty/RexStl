...
REX_RSL_BEGIN_NAMESPACE
    ...
    public:
        ...
        hash_map(ForwardIterator first, ForwardIterator last, size_type bucketCount = 0, const Hash& hashFunction,
        const KeyEqual& equal, const allocator_type& allocator = allocator_type())
    ...
    class hash_multimap<Key, key_value<const Key, T>, Allocator, use_first<key_value<const Key, T>, Hash, mod_range_hashing, default_Ranged_hash, prime_rehash_policy, true, false>
    {
    public:
