...
namespace rsl
{
    ...
    basic_ostream<Char, Traits>& operator<<(basic_ostream<Char, Traits>& os, const basic_string<Char, Traits, allocator>& str)
    {
    ...
    {
        //return rsl::wcstrtol(str.data(), &str_end, base);
        REX_STATIC_TODO("Implement");
        return rsl::nullopt;
    }
    /// RSL Comment: Different from ISO C++ Standard at time of writing (27/Aug/2022)
    // returns an optional instead of a basic type
    ...
    {
        //return rsl::wcsol(str.data(), &str_end, base);
        REX_STATIC_TODO("Implement");
        return rsl::nullopt;
    }
    /// RSL Comment: Different from ISO C++ Standard at time of writing (27/Aug/2022)
    ...
    {
        //return rsl::wcsoll(str.data(), &str_end, base);
        REX_STATIC_TODO("Implement");
        return rsl::nullopt;
    }
    ...
    {
        //return rsl::wcstoul(str.data(), &str_end, base);
        REX_STATIC_TODO("Implement");
        return rsl::nullopt;
    }
    // interprets an unsigned integer value in the string
    ...
    {
        //return rsl::wcstoull(str.data(), &str_end, base);
        REX_STATIC_TODO("Implement");
        return rsl::nullopt;
    }
    ...
    {
        //return rsl::wcstof(str.data(), &str_end);
        REX_STATIC_TODO("Implement");
        return rsl::nullopt;
    }
    // interprets a floating point value in a string
    ...
    {
        //return rsl::wcstod(str.data(), &str_end);
        REX_STATIC_TODO("Implement");
        return rsl::nullopt;
    }
    // interprets a floating point value in a string
    ...
    {
        //return rsl::wcstold(str.data(), &str_end);
        REX_STATIC_TODO("Implement");
        return rsl::nullopt;
    }
...
#pragma warning(pop)
    ...
    basic_string(InputIt, InputIt, Alloc = Alloc())
        -> basic_string <
            typename rsl::iterator_traits<InputIt>::value_type,
            rsl::char_traits<typename rsl::iterator_traits<InputIt>::value_type>,
            Alloc>;
        ...
        explicit basic_string(rsl::basic_string_view<Char, Traits>, const Alloc & = Alloc())
    ...
    explicit basic_string(
        rsl::basic_string_view<Char, Traits>,
        typename rsl::basic_string_view<Char, Traits>::size_type,
        typename rsl::basic_string_view<Char, Traits>::size_type,
        const Alloc & = Alloc())
        ->basic_string<Char, Traits, Alloc>;
    ...
    template <typename CharType, typename Traits = char_traits<CharType>, typename Alloc = allocator>
    using BasicString = basic_string<CharType, Traits, Alloc>;

    using String =BasicString<char8>;
    using WString = BasicString<tchar>;
