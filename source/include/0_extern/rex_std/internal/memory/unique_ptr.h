...
REX_RSL_BEGIN_NAMESPACE
    ...
    public:
        ...
        {}
        // construct a unique_ptr that owns ptr and copy constructs the deleter
        template <typename T2, typename Deleter2, enable_if_t<conjunction_v<negation<is_array<T2>>, is_convertible<typename unique_ptr<T2, Deleter2>::pointer, pointer>, conditional_t<is_reference_v<Deleter>, is_same<Deleter, Deleter>, is_convertible<Deleter2, Deleter>>>, bool> = true>
