...
namespace rsl
{
    namespace internal
    {
        ...
        {
            static constexpr bool value = sizeof(Functor) <= sizeof(FunctorStorage<SizeInBytes>) &&
                (rsl::alignment_of_v<FunctorStorage<SizeInBytes>> % rsl::alignment_of_v<Functor>) == 0;
        };
        ...
        public:
            ...
            public:
                ...
                static void* manager(void* to, void* from, typename FunctionDetailBase::ManagerOperations ops)
                {
                    ...
                    {
                        copy_functor(*static_cast<functor_storage_type*>(to),
                            *static_cast<const functor_storage_type*>(from));
                    }
                    break;
                    case FunctionDetailBase::ManagerOperations::MoveFunctor:
                    {
                        move_functor(*static_cast<functor_storage_type*>(to),
                            *static_cast<functor_storage_type*>(from));
        ...
        public:
            ...
            void swap(FunctionDetail& other)
            {
                ...
                {
                    (*other.m_func_ptr_mgr)(
                        static_cast<void*>(&tmp_storage),
                        static_cast<void*>(&other.storage()),
                        base::ManagerOperations::MoveFunctor);
                }
        ...
        private:
            ...
            void copy(const FunctionDetail& other)
            {
                if (other.has_manager())
                {
                    (*other.m_func_ptr_mgr)(
                        static_cast<void*>(&base::storage()),
                        const_cast<void*>(static_cast<const void*>(&other.storage())),
                        base::ManagerOperations::CopyFunctor
                        );
                }
    ...
    namespace internal
    {
        ...
        struct DeduceSignature {}; // can't deduce signature when &Fx::operator() is missing, inaccessible, or ambiguous

        template <typename Fx>
        struct DeduceSignature<Fx, void_t<decltype(&Fx::operator())>>
            : is_member_function_pointer<decltype(&Fx::operator())>::GuideType {};
    }
