...
namespace internal
{
  ...
  struct Invoker1<Callable, T1, RemovedCVRef, true, false>
      : conditional_t<is_base_of_v<typename is_member_function_pointer<RemovedCVRef>::class_type, remove_reference_t<T1>>, InvokerPmfObject, conditional_t<is_specialization_v<RemoveCVRef<T1>, reference_wrapper>, InvokerPmfRewrap, InvokerPmfPointer>>
  {
