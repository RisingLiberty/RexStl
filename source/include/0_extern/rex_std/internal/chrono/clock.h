...
namespace rsl::chrono
{
...
#else
            const auto leap_cmp = utc_leap_second > time_floor ? strong_ordering::greater
                                 : utc_leap_second == time_floor ? strong_ordering::equal
    ...
    template <typename Clock>
    constexpr bool is_clock_v<Clock, void_t<
                                typename Clock::rep, 
