...
namespace rsl::chrono
{
    ...
    public:
        ...
        constexpr time_point(const time_point<Clock, Duration2>& t,
                            typename enable_if_t<is_convertible_v<Duration2, duration>>** = 0)
        ...
        time_point& operator+=(const duration& d) { m_duration += d; return *this; }
        time_point& operator-=(const duration& d) { m_duration -= d; return *this; }
	...
	constexpr time_point<Clock, typename common_type<Duration2, duration<Rep1, Period1>>::type>
	...
	constexpr time_point<Clock, ToDuration> time_point_cast(
	    ...
	    typename enable_if<internal::IsDuration<ToDuration>::value>::type** = 0)
	{
