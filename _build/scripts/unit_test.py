...
if __name__ == "__main__":
  ...
  if args.create:
    ...
    regis.test.create_new_project(args.solution_folder, args.projects[0], regis.test.TestProjectType.UnitTest)
    exit(0)

  start = time.perf_counter()

  regis.test.test_unit_tests(args.projects, args.clean, args.build_single_threaded, args.enable_asan, args.enable_ubsan, args.enable_coverage)
